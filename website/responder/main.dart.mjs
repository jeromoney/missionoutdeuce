...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1308: (x0,x1) => x0.initialize(x1),
      _1309: (x0,x1) => x0.initTokenClient(x1),
      _1310: (x0,x1) => x0.initCodeClient(x1),
      _1312: (x0,x1) => x0.warn(x1),
      _1313: x0 => x0.disableAutoSelect(),
      _1321: Date.now,
      ...
      _1699: () => globalThis.google.accounts.oauth2,
      ...
      _1706: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12) => ({client_id: x0,scope: x1,include_granted_scopes: x2,redirect_uri: x3,callback: x4,state: x5,enable_granular_consent: x6,enable_serial_consent: x7,login_hint: x8,hd: x9,ux_mode: x10,select_account: x11,error_callback: x12}),
      _1707: x0 => x0.code,
      _1710: x0 => x0.error,
      ...
      _1715: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1716: x0 => x0.requestAccessToken(),
      _1717: (x0,x1) => x0.requestAccessToken(x1),
      _1718: (x0,x1,x2,x3,x4,x5,x6) => ({scope: x0,include_granted_scopes: x1,prompt: x2,enable_granular_consent: x3,enable_serial_consent: x4,login_hint: x5,state: x6}),
      _1719: x0 => x0.access_token,
      _1720: x0 => x0.expires_in,
      _1723: x0 => x0.token_type,
      _1726: x0 => x0.error,
      _1729: x0 => x0.type,
      _1734: () => globalThis.google.accounts.id,
      ...
      _1762: x0 => x0.error,
      _1764: x0 => x0.credential,
      _2100: (x0,x1) => { x0.nonce = x1 },
      _3138: (x0,x1) => { x0.src = x1 },
      _3144: (x0,x1) => { x0.async = x1 },
      _3146: (x0,x1) => { x0.defer = x1 },
      _3607: () => globalThis.window,
      _3648: x0 => x0.document,
      _3932: x0 => x0.trustedTypes,
      _6214: x0 => x0.signal,
      _6223: x0 => x0.length,
      _6284: () => globalThis.document,
      _6367: x0 => x0.head,
      _6701: (x0,x1) => { x0.id = x1 },
      _8047: x0 => x0.value,
      _8049: x0 => x0.done,
      _8751: x0 => x0.url,
      _8753: x0 => x0.status,
      _8755: x0 => x0.statusText,
      _8756: x0 => x0.headers,
      _8757: x0 => x0.body,
      _12383: x0 => x0.name,
      _13102: () => globalThis.console,
      _13124: x0 => { globalThis.onGoogleLibraryLoad = x0 },
      _13125: (module,f) => finalizeWrapper(f, function() { return module.exports._13125(f,arguments.length) }),
