...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1570: (x0,x1) => x0.querySelectorAll(x1),
      ...
      _1701: () => globalThis.google.accounts.oauth2,
      ...
      _1708: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12) => ({client_id: x0,scope: x1,include_granted_scopes: x2,redirect_uri: x3,callback: x4,state: x5,enable_granular_consent: x6,enable_serial_consent: x7,login_hint: x8,hd: x9,ux_mode: x10,select_account: x11,error_callback: x12}),
      _1709: x0 => x0.code,
      _1712: x0 => x0.error,
      ...
      _1717: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _1718: x0 => x0.requestAccessToken(),
      _1719: (x0,x1) => x0.requestAccessToken(x1),
      _1720: (x0,x1,x2,x3,x4,x5,x6) => ({scope: x0,include_granted_scopes: x1,prompt: x2,enable_granular_consent: x3,enable_serial_consent: x4,login_hint: x5,state: x6}),
      _1721: x0 => x0.access_token,
      _1722: x0 => x0.expires_in,
      _1725: x0 => x0.token_type,
      _1728: x0 => x0.error,
      _1731: x0 => x0.type,
      _1736: () => globalThis.google.accounts.id,
      ...
      _1764: x0 => x0.error,
      _1766: x0 => x0.credential,
      _2102: (x0,x1) => { x0.nonce = x1 },
      _3140: (x0,x1) => { x0.src = x1 },
      _3146: (x0,x1) => { x0.async = x1 },
      _3148: (x0,x1) => { x0.defer = x1 },
      _3609: () => globalThis.window,
      _3650: x0 => x0.document,
      _3934: x0 => x0.trustedTypes,
