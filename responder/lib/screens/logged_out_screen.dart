            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Responder view for alerts, acknowledgement, and mission updates.',
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      style: OutlinedButton.styleFrom(
                        foregroundColor: ResponderPalette.text,
  ...
  InputDecoration _inputDecoration({
    ...
    return InputDecoration(
      ...
      border: OutlineInputBorder(
        ...
        borderSide: const BorderSide(color: ResponderPalette.border),
      ),
